...
CREATE TABLE IF NOT EXISTS competition_directions (
    ...
    CONSTRAINT fk_direction_competition FOREIGN KEY (direction_id) REFERENCES directions (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS competition_participation_types (
    ...
    CONSTRAINT fk_competition_participation_type FOREIGN KEY (competition_id) REFERENCES competitions (id) ON DELETE CASCADE,
    CONSTRAINT fk_participation_type_competition FOREIGN KEY (participation_type_id) REFERENCES participation_types (id) ON DELETE CASCADE
);